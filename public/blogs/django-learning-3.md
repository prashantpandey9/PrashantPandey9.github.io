...
I started a django project by typing the command `django-admin startproject` and in this folder I created my app by typing the command `django-admin startapp`. These commands directs the django software in your machine and it creates many files related to this project.
