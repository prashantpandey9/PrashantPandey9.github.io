...
So here in this example if we need to change the state of isLoading state to true we just need to call the action loading() in the component and it will automatically update the state for all. This is it for now, if you have any question you can dm me. Contact shared in my [portfolio](https://prashantpandey.ml/).
